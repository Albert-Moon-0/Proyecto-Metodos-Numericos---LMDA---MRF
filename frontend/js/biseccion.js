// Lógica de interfaz para Bisección.
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function pintarTabla(iteraciones) {
        ...
        iteraciones.forEach((fila, indice) => {
            ...
            const celdas = [
                ...
                formatearNumero(fila.errorAbsoluto),
                formatearNumero(fila.errorAproximado),
            ];
    ...
    botonCalcular?.addEventListener('click', async function () {
        ...
        try {
            ...
            const resultado = await llamarApi('/api/biseccion/calcular', datos);
